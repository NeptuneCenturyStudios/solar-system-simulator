...
import { loadAsteroidVariant6ModelTemplate } from './asteroid-model-cache';
...
const ASTEROID_RED_MODEL_CONFIG: IAsteroidModelConfig = {
    loadTemplate: loadAsteroidVariant6ModelTemplate,
 ...
 */
export class AsteroidPocked extends AsteroidBase {
    constructor(
