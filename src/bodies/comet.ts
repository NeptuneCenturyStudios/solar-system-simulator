...
export class Comet extends CelestialBody {
    ...
    constructor(
        ...
        this.initTail(scene, options);
    }

    initTail(scene: THREE.Scene, options: ICelestialBodyCreationOptions) {
        // Comet tail
            ...
            const awayFromSun = new THREE.Vector3(options.pos.x, options.pos.y, options.pos.z).normalize();
    ...
    disposeTail() {
        ...
        this.tailAge = new Float32Array(0);
        this.tailOffsets = new Float32Array(0);
        this.tailSpread = new Float32Array(0);
        this.tailNextLife = new Float32Array(0);
        this.tailBaseSize = new Float32Array(0);
    }
}
