...
gl_FragColor = vec4(outgoingLight * alpha, alpha);`
    ...
    private _buildBeamArms(): void {
        ...
        const geo = new THREE.CylinderGeometry(
            this.beamLength * 0.04, // radiusTop  — wide tip
            this.radius * 0.5, // radiusBottom — thin star end
    ...
    private _orientBeamArms(axis: THREE.Vector3): void {
        ...
        if (this.beamMeshNorth) {
            ...
            this.beamMeshNorth.position.copy(this.position.clone().addScaledVector(axis, half));
        }
        ...
        if (this.beamMeshSouth) {
            ...
            this.beamMeshSouth.position.copy(this.position.clone().addScaledVector(axis, -half));
        }
    }
